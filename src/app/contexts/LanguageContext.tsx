...
const translations = {
  ar: {
    ...
    heroSubtitle:
      'أجمل الورود والباقات لجميع مناسباتكم الخاصة',
    ...
    portfolioSubtitle:
      'استكشف مجموعتنا الرائعة من باقات الورود وتنسيقات الزهور',
    ...
    addInstagramLink:
      'يمكنك إضافة رابط إنستغرام الخاص بك هنا',
    ...
    deliveryDesc:
      'نوفر خدمة التوصيل السريع لجميع أنحاء المدينة',

    qualityTitle: 'الجودة',

    qualityDesc:
      'نختار أجود أنواع الورود الطازجة يومياً',
    ...
    customDesc:
      'نصمم باقات خاصة حسب طلبك ومناسبتك',
  ...
  en: {
    ...
    portfolioSubtitle:
      'Explore our stunning collection of rose bouquets and flower arrangements',
    ...
    deliveryDesc:
      'We provide fast delivery service throughout the city',

    qualityTitle: 'Quality',

    qualityDesc:
      'We select the finest fresh roses daily',
    ...
    customDesc:
      'We design special bouquets according to your request and occasion',
